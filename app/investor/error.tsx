...
/**
 * Error boundary for `/investor` itself (the Discover compatibility
 * redirect) - added in the pre-launch hardening pass. No loading.tsx
 * alongside this one, same reasoning as app/founder/error.tsx: the page
 * only calls redirect() synchronously.
 */
export default function InvestorRootError({
  error,
  reset,
}: {
