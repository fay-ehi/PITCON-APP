...
/**
 * Notifications' error boundary (Investor side) - added in the
 * pre-launch hardening pass, same pattern as MessagesError/DiscoverError.
 */
export default function InvestorNotificationsError({
  error,
  reset,
}: {
