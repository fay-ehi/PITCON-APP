...
/**
 * Create/Edit startup's error boundary - added in the pre-launch
 * hardening pass, same pattern as MessagesError/DiscoverError.
 */
export default function EditStartupError({
  error,
  reset,
}: {
        ...
        <CardContent className="flex flex-col items-center gap-4 py-14">
          ...
          <div className="flex flex-col gap-1.5">
            <h2 className="text-h3 font-semibold text-gray-900">
              We couldn&apos;t load the startup editor.
            </h2>
