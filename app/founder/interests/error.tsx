...
/**
 * Interests' error boundary - added in the pre-launch hardening pass,
 * same pattern as MessagesError/DiscoverError. getFounderInterests only
 * ever throws a generic Error; this doesn't surface even that, just a
 * retry action.
 */
export default function FounderInterestsError({
  error,
  reset,
}: {
